...
exports.MixPanelContext = undefined;
...
var _MixPanelComponent = __webpack_require__(5);

Object.keys(_MixPanelComponent).forEach(function (key) {
    if (key === "default" || key === "__esModule") return;
    Object.defineProperty(exports, key, {
        enumerable: true,
        get: function get() {
            return _MixPanelComponent[key];
        }
    });
});
...
var MixPanelProvider = function (_React$Component) {
    ...
    function MixPanelProvider() {
        ...
        }, _this.trackEvent = function (event) {
            return _this.setState({ trackedEvents: _extends({}, _this.state.trackedEvents, _defineProperty({}, event.name, event)) });
    ...
    _createClass(MixPanelProvider, [{
        ...
        value: function componentDidMount() {
            var mutationObserver = new MutationObserver(this.mixPanelHasLoaded);
...
var MixPanel = exports.MixPanel = function (_Component) {
    ...
    function MixPanel() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MixPanel.__proto__ || Object.getPrototypeOf(MixPanel)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            callbackQueu: []
        }, _this.triggerCallbacks = function (mixPanelContext) {
            _this.state.callbackQueu.forEach(function (callback) {
                ...
                if ((typeof callback === 'undefined' ? 'undefined' : _typeof(callback)) === 'object') {
                    ...
                    window.mixpanel.track(callback.event.name, _extends({}, callback.event.customProperties));
                }
            });

            _this.setState({ callbackQueu: [] });
        }, _this.setEvent = function (mixPanelContext) {
            ...
            return function (eventHandler) {
                ...
                window.mixpanel.track(event.name, _extends({}, event.customProperties));
                eventHandler();
            };
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(MixPanel, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                _.MixPanelContext.Consumer,
                null,
                function (mixPanelContext) {
                    if (mixPanelContext.isLoaded && _this2.state.callbackQueu.length) {
                        _this2.triggerCallbacks(mixPanelContext);
                        return null;
                    }
                    return _react2.default.createElement(
                        _react.Fragment,
                        null,
                        _this2.props.render(_this2.setEvent(mixPanelContext))
                    );
                }
            );
        }
